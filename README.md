...
🔊🔊 **Check out [this new document](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5432595) with examples on how to implement the did_multiplegt_stat, with two real datasets**. 🔊🔊
