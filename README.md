...
🔊🔊 **Check out [this]([https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5337463](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5432595)) new document with examples on how to implement the did_multiplegt_stat, with two examples of real datasets**. 🔊🔊
